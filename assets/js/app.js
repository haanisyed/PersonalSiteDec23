...
<a class="navbar-brand" href="index.html">Haani Syed </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item">
   <input type="checkbox" id="dark_toggler" class="dark_toggler" aria-label="Toggle Dark Mode" onclick="toggle_dark_mode()">
   </li>
   <div class="bike">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/57TE1xx4ip" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/haanisyed/" target="_blank" >
    ...
    <a class="social-button github" href="https://www.github.com/haanisyed" target="_blank">
